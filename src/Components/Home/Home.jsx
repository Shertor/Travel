...
export default function Home() {
	...
	const { homeLoaded, setHomeLoaded } = useContext(Context)
							...
							<div className="trips__container bd-container">
								<div className="trips__data">
									...
									<p className="trips__description">
										Kemer is a seaside resort and district of Antalya Province
										on the Mediterranean coast of Turkey, 43 km (27 mi) west of
										the city of Antalya, on the Turkish Riviera.
									</p>
							...
							<div className="trips__container bd-container">
								<div className="trips__data">
									...
									<p className="trips__description">
										...
										straddles the Bosporus strait, lying in both Europe and
										Asia, and has a population of over 15 million residents,
										comprising 19% of the population of Turkey. Istanbul is the
										most populous European city, and the world's 15th-largest
										city.
									</p>
									<NavLink to="/Explore" className="trips__button">
										Explore{' '}
